...
## this function extracts the different timings for a play
...
write.csv(unique(pre_steal),file = "steal_plays_and_base_runners.csv")


## exploring catcher and pitchers by allowed steals
